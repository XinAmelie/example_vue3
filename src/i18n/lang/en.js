export default {
  ...
  guide: {
    ...
    next: 'next text',
    prev: 'previous text',
    guideTitle: 'Boot start',
    guideDesc: 'This is the bootstrap test'
  },
  excel: {
    importExcel: 'Excell import',
    exportExcel: 'Excell export'

  },
  uploadExcel: {
    upload: 'File Upload',
    filed: 'Drag and drop files here'
  },
  article: {
